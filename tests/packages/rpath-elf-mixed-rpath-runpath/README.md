# rpath-elf-mixed-rpath-runpath

Preserve an executable with DT_RPATH and a middle library with DT_RUNPATH.
...
```sh
python -m pytest tests/test_rpath_packages.py -k 'rpath_elf_mixed_rpath_runpath' -vv
```
